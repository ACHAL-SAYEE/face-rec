...
with mp_face_mesh.FaceMesh(min_detection_confidence=0.2, min_tracking_confidence=0.2) as face_mesh:
    while cap.isOpened():
        ...
        cv2.namedWindow("YOLOv8 + DeepSORT Attendance", cv2.WINDOW_NORMAL) 
  
        # Using resizeWindow() 
        # cv2.setWindowProperty("YOLOv8 + DeepSORT Attendance", cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
